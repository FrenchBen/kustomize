...
var sourceOCIProvidersToOCIProvider = map[string]oci.Provider{
	v1beta2.GenericOCIProvider: oci.ProviderGeneric,
	v1beta2.AmazonOCIProvider:  oci.ProviderAWS,
	v1beta2.AzureOCIProvider:   oci.ProviderAzure,
	v1beta2.GoogleOCIProvider:  oci.ProviderGCP,
}
